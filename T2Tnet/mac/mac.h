...
#define MAC_SLEEP_PERIOD_ACLK			10000					// Ticks with 32.768 kHz CLK
#define MAC_RX_TIMEOUT_ACLK				2*MAC_SLEEP_PERIOD_ACLK + 400	// Ticks with 32.768 kHz CLK
